...
class TestCompanyModel(unittest.TestCase):
    ...
    def test_company_name_should_be_unique(self):
        with self.assertRaises(IntegrityError):
            self.default_company.save()
            company_another = Company(name='Apple', address_line_1='Somewhere',city=self.city, state=self.state, pin_code='560010',landline_number='080-35353534',tin='1111111',tan='111111111',service_tax_number='11111111',)
    ...
    def test_not_valid_if_city_state_are_missing(self):
        with self.assertRaises(ValueError):
            company_another = Company(name='Apple1', address_line_1='Somewhere',city=None, state=None, pin_code='560010',landline_number='080-35353534',tin='1111111',tan='111111111',service_tax_number='11111111',)
            company_another.save()
    ...
    def test_state_is_set_based_on_the_city_chosen(self):
        ...
        company_another = Company(name='Apple2', address_line_1='Somewhere',city=self.city, state=another_state, pin_code='560010',landline_number='080-35353534',tin='1111111',tan='111111111',service_tax_number='11111111',)
        company_another.save()
